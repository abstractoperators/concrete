...
import pytest
from concrete_core.models import messages
from concrete_core.tools import HTTPTool, invoke_tool
...
@patch('concrete_core.tools.HTTPClient')
...
class TestInvokeTool(unittest.TestCase):
    @patch('concrete_core.tools.TOOLS_REGISTRY', new_callable=dict)
