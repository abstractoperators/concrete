...
def upgrade() -> None:
    ...
    op.create_table('tool', sa.Column('id', sa.Uuid(), nullable=False), sa.PrimaryKeyConstraint('id'))
    op.create_table(
        'message',
        sa.Column('id', sa.Uuid(), nullable=False),
        ...
        sa.Column(
            'status', sa.Enum('INIT', 'READY', 'WORKING', 'WAITING', 'FINISHED', name='projectstatus'), nullable=False
        ),
