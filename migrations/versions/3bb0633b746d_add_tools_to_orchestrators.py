...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_operatortoollink_operator_id'), 'operatortoollink', ['operator_id'], unique=False)
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_orchestratortoollink_orchestrator_id'), table_name='orchestratortoollink')
