...
class Developer(AbstractOperator):
    ...
    def ask_question(self, context: str, *args, **kwargs):
        """
    ...
    def implement_component(self, context: str, *args, **kwargs):
        """
    ...
    def implement_html_element(self, prompt: str, *args, **kwargs):
        out_str = f"""\
