...
class OrchestratorBase(Base):
    # TODO turn into enum
    type: str | None = Field(description="type of orchestrator", max_length=32, default=None)
...
class OperatorBase(Base, ProfilePictureMixin):
    instructions: str = Field(description="Instructions and role of the operator.", min_length=1)
    name: str = Field(description="Name of the operator.", max_length=32)
...
class OperatorUpdate(Base, ProfilePictureMixin):
    ...
    name: str | None = Field(description="Name of the operator.", max_length=32, default=None)
...
class ProjectUpdate(Base):
    name: str | None = Field(description="Name of the project.", max_length=32, default=None)
